...
var c w r y h k i z productividad;

varexo eps_z;

parameters beta delta theta rho A sigma_eps;
...
sgtitle('Estadísticas: Modelo - Trabajo Divisible');
...
exportgraphics(fig_histogram, 'stats_Trabajo_divisible.png', 'Resolution', 300);
